...
EMMA_REGISTERS = {
    ...
    rn.EMMA_EXTERNAL_METER_RUNNING_STATUS: U16Register(
        rv.EmmaExternalMeterRunningStatus,    # NEED TO DEFINE in register_values.py   0:online   1:offline
        ?,                                    # No default value... How to enter?
        30500,
        writeable=False,
    ...
    rn.EMMA_EXTERNAL_METER_TOTAL_NEGATIVE_ACTIVE_ENERGY: I64Register("kWh", 100, 30542, target_device=TargetDevice.EMMA),
    rn.EMMA_EXTERNAL_METER_TOTAL_POSITIVE_ACTIVE_ENERGY: I64Register("kWh", 100, 30550, target_device=TargetDevice.EMMA),

    rn.NUMBER_OF_INVERTERS_FOUND: U16Register(None, None, 30801, target_device=TargetDevice.EMMA),
    rn.NUMBER_OF_CHARGERS_FOUND: U16Register(None, None, 30804, target_device=TargetDevice.EMMA),
    ...
    rn.TOTAL_NEGATIVE_ACTIVE_ENERGY_BUILT_IN_ENERGY_SENSOR: I64Register("kWh", 100, 31679, target_device=TargetDevice.EMMA),
    rn.TOTAL_POSITIVE_ACTIVE_ENERGY_BUILT_IN_ENERGY_SENSOR: I64Register("kWh", 100, 31687, target_device=TargetDevice.EMMA),
    ...
    rn.TOTAL_NEGATIVE_ACTIVE_ENERGY_EXTERNAL_ENERGY_SENSOR: I64Register("kWh", 100, 31935, target_device=TargetDevice.EMMA),
    rn.TOTAL_POSITIVE_ACTIVE_ENERGY_EXTERNAL_ENERGY_SENSOR: I64Register("kWh", 100, 31943, target_device=TargetDevice.EMMA),    

    rn.EMMA_ESS_CONTROL_MODE: I16Register(
        rv.EmmaEssControlMode,    # NEED TO DEFINE in register_values.py
        2,
        40000,
        writeable=True,
        target_device=TargetDevice.EMMA,
    ...
    rn.EMMA_POWER_CONTROL_MODE_AT_GRID_CONNECTION_POINT:  U16Register(
        rv.EmmaPowerControlModeAtGridConnectionPoint,    # NEED TO DEFINE in register_values.py  0:unlimited 5: grid connected with zero power 6: limited feed-in (kW) 7: power-limited grid connected (%)
        0,
        40100,
        writeable=True,
        target_device=TargetDevice.EMMA,
    ...
    rn.EMMA_LIMITATION_MODE:  U16Register(
        rv.EmmaLimitationMode,    # NEED TO DEFINE in register_values.py  0:total power   1:single-phase power
        0,
        40101,
        writeable=True,
        target_device=TargetDevice.EMMA,
    ), 
    rn.EMMA_MAXIMUM_FEED_GRID_POWER_WATT: I32Register("W", 1, 40107, writeable=True, target_device=TargetDevice.EMMA),      # Was 47416
    rn.EMMA_MAXIMUM_FEED_GRID_POWER_PERCENT: U16Register("%", 10, 40109, writeable=True, target_device=TargetDevice.EMMA),  # Was 47418
    rn.EMMA_3PHASE_IMBALANCE_CONTROL:  U16Register(
        rv.Emma3PhaseImbalanceControl,    # NEED TO DEFINE in register_values.py  0:disabled   1:enabled
        0,
        40110,
        writeable=True,
        target_device=TargetDevice.EMMA,
    ...
    rn.EMMA_POWER_SUPPLY_CONFIGURATION:  U16Register(
        rv.EmmaPowerSupplyConfiguration,    # NEED TO DEFINE in register_values.py  0:none   1:mains only   2:mains+generator   3:generator only
        0,
        41214,
        writeable=True,
        target_device=TargetDevice.EMMA,
    ...
    rn.EMMA_CONSIDER_MAINS_FAULTY_IF:  U16Register(
        rv.EmmaConsiderMainsFaultyIf,    # NEED TO DEFINE in register_values.py  0:open   1:closed
        0,
        41215,
        writeable=True,
        target_device=TargetDevice.EMMA,
